...
echo "CHANGE MASTER TO MASTER_HOST='10.10.10.104', MASTER_USER='repl', MASTER_PASSWORD='oTUSlave#2020', MASTER_LOG_FILE='binlog.000001', MASTER_LOG_POS=XXX, GET_MASTER_PUBLIC_KEY = 1;"
echo " "
